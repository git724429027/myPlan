...
public class TestLambda {
    ...
    List<Employee> employees = Arrays.asList(
        new Employee(1,"张三", 18, 9496.2),
        new Employee(2,"李四", 52, 2396.2),
        new Employee(3,"王五", 56, 996.2),
        new Employee(4,"赵六", 8, 94.2)
    );
    ...
    @Test
    public void test4() {
        List<Employee> emps = filterEmplyees(employees, new FilterEmployeeForAge());
        for (Employee e : emps) {
            System.out.println(e);
        }
        System.out.println("---------------------");
        List<Employee> emps2 = filterEmplyees(employees, new FilterEmployeeForSalary());
        for (Employee e : emps2) {
            System.out.println(e);
        }
    }
