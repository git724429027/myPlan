...
//  */
// package com.wang.obs.samples_java;
//
...
//
// 	private static shade.okhttp3.OkHttpClient httpClient = new shade.okhttp3.OkHttpClient.Builder().followRedirects(false)
...
// 	}
//
// 	private static shade.okhttp3.Request.Builder getBuilder(TemporarySignatureResponse res) {
// 		shade.okhttp3.Request.Builder builder = new shade.okhttp3.Request.Builder();
...
// 		System.out.println("\t" + res.getSignedUrl());
// 		shade.okhttp3.Request.Builder builder = getBuilder(res);
// 		builder.url(res.getSignedUrl()).put(shade.okhttp3.RequestBody.create(null, "".getBytes("UTF-8")));
...
// 		System.out.println("\t" + res.getSignedUrl());
// 		shade.okhttp3.Request.Builder builder = getBuilder(res);
// 		builder.put(shade.okhttp3.RequestBody.create(shade.okhttp3.MediaType.parse(contentType), "Hello OBS".getBytes("UTF-8")));
// 		getResponse(builder.build());
// 	}
//
...
//
// 		shade.okhttp3.Request.Builder builder = getBuilder(res);
// 		builder.put(shade.okhttp3.RequestBody.create(shade.okhttp3.MediaType.parse("application/xml"), requestXml.getBytes("UTF-8")));
// 		getResponse(builder.build());
//
// 		TemporarySignatureRequest req2 = new TemporarySignatureRequest(HttpMethodEnum.GET, 300);
// 		req2.setBucketName(bucketName);
...
// 		getResponse(getBuilder(res).put(shade.okhttp3.RequestBody.create(null, content.getBytes("UTF-8"))).build());
// 	}
//
// }
