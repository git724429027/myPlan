...
// 	}
//
// 	private static shade.okhttp3.OkHttpClient GetHttpClient() {
...
// 		};
//
// 		shade.okhttp3.OkHttpClient.Builder builder = new shade.okhttp3.OkHttpClient.Builder().followRedirects(false).retryOnConnectionFailure(false)
...
// 	                 String credential = shade.okhttp3.Credentials.basic(proxyUser, proxyPassword);
...
// 		return shade.okhttp3.RequestBody.create(shade.okhttp3.MediaType.parse(mimeType), content.getBytes("UTF-8"));
// 	}
// }
